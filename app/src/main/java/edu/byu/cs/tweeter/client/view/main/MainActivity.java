...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedUser.compareTo(Cache.getInstance().getCurrUser()) == 0) {
            ...
            presenter.setFollowButton(selectedUser);
        }
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                presenter.onFollowButtonClick(followButton.getText().toString().equals(v.getContext().getString(R.string.following)),
                                            selectedUser);
            }
        });
    }
    ...
    @Override
    public void setCount(boolean isFollowingCount, int count) {
        if (isFollowingCount) {
